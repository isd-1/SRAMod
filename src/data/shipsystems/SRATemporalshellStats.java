...
public class SRATemporalshellStats extends BaseShipSystemScript {
    ...
    public static final float DAMPER_MULT = 0.75f;
    public static final int MAX_ASPECTS = 4;
    ...
    public void processAspectSpawn(ShipAPI ship) {
        ...
        ShipAPI leader = engine.getFleetManager(ship.getOwner()).spawnShipOrWing(wingId, ship.getLocation(), ship.getFacing(), 2f);
